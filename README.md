HexToDec. VB.Net Tutorials. Simple Input/Output. Strings. Algorithms. DotNet Core Platform. Console Application. 
...
HexToDec. Занятия по VB.Net. Простой ввод/вывод. Строки. Алгоритмы. Платформа DotNet Core. Консольное приложение.
